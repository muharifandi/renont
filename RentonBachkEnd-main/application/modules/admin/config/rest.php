...
$config['auth_override_class_method']['basic']['*'] = 'none';

$config['auth_override_class_method']['partner']['index'] = 'none';
$config['auth_override_class_method']['partner']['login'] = 'none';
$config['auth_override_class_method']['partner']['register'] = 'none';

$config['auth_override_class_method']['customer']['index'] = 'none';
$config['auth_override_class_method']['customer']['login'] = 'none';
$config['auth_override_class_method']['customer']['register'] = 'none';
$config['auth_override_class_method']['customer']['activate'] = 'none';
$config['auth_override_class_method']['customer']['home'] = 'none';

$config['auth_override_class_method']['rentVehicle']['list'] = 'none';
$config['auth_override_class_method']['rentVehicle']['detail'] = 'none';
