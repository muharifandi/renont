        ...
        <div class="col-xs-6">
          <div class="box">
			...
			<center><span style=" color:red;"><?php echo $message;?></span></center>
				<form role="form" method="post" action="<?php echo base_url().'agent/config/profile_update';?>" enctype="multipart/form-data">
				<div class="box-body">
					<div class="form-group">
					  <label>Email/Alamat Surel *</label>
					  <input disabled type="text" class="form-control" name="email" placeholder="contoh : dani@rentone.com" value="<?php echo ($agent->email)?$agent->email:"";?>">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
					  <label>Sandi *</label><span style="font-size:10px;color:red;">( isi sandi dan konfirmasi jika ingin mengganti sandi. kosongkan jika tidak ingin mengganti sandi)</span>
