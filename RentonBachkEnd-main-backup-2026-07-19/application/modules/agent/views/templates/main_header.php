...
<div class="wrapper">
  <header class="main-header">
    <!-- Logo -->
    <a href="<?php echo base_url(); ?>agent/dashboard" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>R</b>O</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Rent</b>On Marketing</span>
    </a>
		...
		<!--
         ...
         -->
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url()."data/agents/profile/thumb_".$agent->img_profile;?>" class="user-image" alt="User Image">
