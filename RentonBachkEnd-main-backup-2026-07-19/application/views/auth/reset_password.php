...
<div class="login-box">
  ...
  <div class="login-box-body">
	<center><h3><?php echo lang('reset_password_heading');?></h3></br><p><?php echo sprintf(lang('forgot_password_subheading'), $identity_label);?></p></center>
	<center><span style="color:red"><div id="infoMessage"><?php echo $message;?></div></span></center>
    <form action="<?php echo base_url()."auth/reset_password/". $code; ?>" method="post">
      <div class="form-group has-feedback">
        <input type="password" name="new" class="form-control" placeholder="<?php echo sprintf(lang('reset_password_new_password_label'), $min_password_length);?>" value="">
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
      </div>
	  <div class="form-group has-feedback">
        <input type="password" name="new_confirm" class="form-control" placeholder="<?php echo sprintf(lang('reset_password_new_password_confirm_label'), 'new_password_confirm');?>" value="">
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
      </div>
      <div class="row">
        ...
        <div class="col-sm-12">
          <button type="submit" class="btn btn-primary btn-block btn-flat">Reset Sandi</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
