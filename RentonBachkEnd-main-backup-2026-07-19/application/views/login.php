...
<div class="login-box">
  ...
  <div class="login-box-body">
	...
	<center><span style="color:red"><?php echo(isset($message))?$message:"";?></span></center>
    <form action="<?php echo base_url(); ?>auth/login" method="post">
      ...
      <div class="row">
        <div class="col-xs-8">
          <a href="<?php echo base_url()."auth/forgot_password";?>"> Lupa Sandi</a>
        </div>
        <!-- /.col -->
        <div class="col-xs-4">
