...
*/
$config['tables']['users']           = 'accounts';
$config['tables']['groups']          = 'groups';
$config['tables']['users_groups']    = 'accounts_groups';
 ...
 */
$config['site_title']                 = "Orderki";       // Site Title, example.com
$config['admin_email']                = "no-replay@orderki.com"; // Admin Email, admin@example.com
