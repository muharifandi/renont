...
<div class="content-wrapper">
    ...
    <section class="content-header">
		<h1>
			Konfigurasi
			<small>Bank Perusahaan</small>
		</h1>
		<ol class="breadcrumb">
			<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
			<li><a href="#">Konfigurasi</a></li>
			<li class="active">Bank Perusahaan</li>
		</ol>
	</section>
			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Bank Perusahaan</h3>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
...
<script>
	...
	$(document).ready(function(){
		table = $('#list').DataTable({
			...
			"ajax": {
				method : 'GET',
				url : base_url+"admin/config/get_list_bank_company"
			},
			'columns': [
			{ data: 'id' },
			{ data: 'icon' },
		...
		$('#list').on('click','.btn-edit', function() {
			...
			$.ajax({
				method: 'post',
				url: base_url+"admin/config/get_bank_company/"+current_id,
				cache: false,
				dataType: 'json',
		...
		$('#post').click(function() {
			$.ajax({
				method: 'post',
				url: base_url+"admin/config/post_bank_company/"+(is_edit?current_id:""),
				cache: false,
		...
		$('#delete-item').click(function() {
			$.ajax({
				method: 'post',
				url: base_url+"admin/config/delete_bank_company/"+current_id,
				cache: false,
				dataType: 'json',
				success: function(data){
					if(data.status)
