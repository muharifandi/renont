			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Merek</h3>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
						<div class="form-group">
							<button id="add" class="btn btn-sm btn-primary">Tambah Merek</button>
						</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 id="input_title" class="modal-title">Tambah Merek</h4>
				</div>
	...
	<div class="modal fade" id="delete-modal">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					Apa kamu yakin ingin menghapus merek ini?
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
	...
	<script>
		...
		$(document).ready(function(){
			table = $('#list').DataTable({
				...
				"ajax": {
					method : 'GET',
					url : base_url+"admin/rentVehicle/get_list_brand"
				},
				'columns': [
				{ data: 'id' },
				{ data: 'icon' },
			...
			$('#list').on('click','.btn-edit', function() {
				...
				$.ajax({
					method: 'post',
					url: base_url+"admin/rentVehicle/get_brand/"+current_id,
					cache: false,
					dataType: 'json',
			...
			$('#post').click(function() {
				...
				$.ajax({
					method: 'post',
					url: base_url+"admin/rentVehicle/post_brand/"+(is_edit?current_id:""),
					cache: false,
			...
			$('#delete-item').click(function() {
				$.ajax({
					method: 'post',
					url: base_url+"admin/rentVehicle/delete_brand/"+current_id,
					cache: false,
					dataType: 'json',
					success: function(data){
						if(data.status)
