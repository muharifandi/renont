...
<div class="content-wrapper">
    ...
    <section class="content-header">
		<h1>
			Marketing
			<small>List Transaksi Komisi</small>
		</h1>
		<ol class="breadcrumb">
			<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
			<li><a href="#">Marketing</a></li>
			<li class="active">List Transaksi Komisi</li>
		</ol>
	</section>
			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">List Transaksi Komisi</h3>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
...
<script>
	...
	$(document).ready(function(){
		...
		"ajax": {
			method : 'GET',
			url : base_url+"admin/agent/get_list_transaction"
		},
		'columns': [
		{ data: 'id' },
		{ data: 'thumb_image' },
