...
<div class="content-wrapper">
    ...
    <section class="content-header">
		<h1>
			Rental Kendaraan
			<small>Jenis Penggerak</small>
		</h1>
		<ol class="breadcrumb">
			<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
			<li><a href="#">Rental Kendaraan</a></li>
			<li class="active">Jenis Penggerak</li>
		</ol>
	</section>
			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Jenis Penggerak</h3>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
						<div class="form-group">
							<button id="add" class="btn btn-sm btn-primary">Tambah Jenis Penggerak</button>
						</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 id="input_title" class="modal-title">Tambah Jenis Penggerak</h4>
			</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
				<span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title">Hapus Jenis Penggerak</h4>
			</div>
			<div class="modal-body">
				Apa kamu yakin ingin menghapus jenis penggerak ini?
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
...
<script>
	...
	$(document).ready(function(){
		table = $('#list').DataTable({
			...
			"ajax": {
				method : 'GET',
				url : base_url+"admin/rentVehicle/get_list_driven_type"
			},
			'columns': [
			{ data: 'id' },
			{ data: 'icon' },
		...
		$('#add').on('click', function (event) {
			$('#input_title').html("Tambah Jenis Penggerak");
			is_edit = false;
			$('#input')[0].reset();
		...
		$('#list').on('click','.btn-edit', function() {
			$('#input_title').html("Ubah Jenis Penggerak");
			...
			$.ajax({
				method: 'post',
				url: base_url+"admin/rentVehicle/get_driven_type/"+current_id,
				cache: false,
				dataType: 'json',
		...
		$('#post').click(function() {
			...
			$.ajax({
				method: 'post',
				url: base_url+"admin/rentVehicle/post_driven_type/"+(is_edit?current_id:""),
				cache: false,
		...
		$('#delete-item').click(function() {
			$.ajax({
				method: 'post',
				url: base_url+"admin/rentVehicle/delete_driven_type/"+current_id,
				cache: false,
				dataType: 'json',
				success: function(data){
					if(data.status)
