        ...
        <div class="row">
            <div class="col-lg-3 col-xs-6">   
                <div class="small-box bg-yellow">
                    <div class="inner">
                        <h3 id="total_partner_transaction">-</h3>
                        <p>Transaksi Mitra</p>
                    </div>
                    <div class="icon">
            ...
            <div class="col-lg-3 col-xs-6">   
                <div class="small-box bg-yellow">
                    <div class="inner">
                        <h3 id="total_commission_transaction">-</h3>
                        <p>Komisi Masuk</p>
                    </div>
                    <div class="icon">
            ...
            <div class="col-lg-3 col-xs-6">  
                <div class="small-box bg-green">
                    <div class="inner">
                        <h3 id="total_partner_register">-</h3>
...
<script type="text/javascript">
    $(document).ready(function(){
        var chartOptions = {
            ...
            {
                $.ajax({
                    url: <?php echo '"'.base_url().'agent/dashboard/get_summary/"';?>+start+"/"+end ,
                    method: 'get',
                    dataType: 'json',
                    }).done(function(result){
                    $('#total_partner_transaction').html(result.total_partner_transaction);
                    $('#total_commission_transaction').html(result.total_commission_transaction);
                    $('#total_partner_register').html(result.total_partner_register);
