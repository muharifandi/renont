package com.rentone.user.presentation.feature.common.listsort
...
import com.rentone.user.databinding.ActivityListSortBinding
...
class ListSortActivity : AppCompatActivity() {
    ...
    override fun finish() {
        super.finish()
        applyExitTransition(com.rentone.user.R.anim.slide_in_left, com.rentone.user.R.anim.slide_out_right)
    }
}
