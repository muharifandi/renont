...
<div class="modal fade" id="delete-modal">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				Apa kamu yakin ingin menghapus Bank ini?
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
...
<script>
	...
	$(document).ready(function(){
		table = $('#list').DataTable({
			...
			"ajax": {
				method : 'GET',
				url : base_url+"admin/config/get_list_bank"
			},
			'columns': [
			{ data: 'id' },
			{ data: 'icon' },
		...
		$('#list').on('click','.btn-edit', function() {
			...
			$.ajax({
				method: 'post',
				url: base_url+"admin/config/get_bank/"+current_id,
				cache: false,
				dataType: 'json',
		...
		$('#post').click(function() {
			...
			$.ajax({
				method: 'post',
				url: base_url+"admin/config/post_bank/"+(is_edit?current_id:""),
				cache: false,
		...
		$('#delete-item').click(function() {
			$.ajax({
				method: 'post',
				url: base_url+"admin/config/delete_bank/"+current_id,
				cache: false,
				dataType: 'json',
				success: function(data){
					if(data.status)
