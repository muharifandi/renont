package com.rentone.user.presentation.feature.partner.rentvehicle.reviewcustomer
...
import com.rentone.user.databinding.ActivityPartnerReviewCustomerTransactionBinding
import dagger.hilt.android.AndroidEntryPoint
import kotlinx.coroutines.launch
import com.rentone.user.core.util.applyExitTransition

@AndroidEntryPoint
class PartnerReviewCustomerTransactionActivity : AppCompatActivity() {

    private lateinit var binding: ActivityPartnerReviewCustomerTransactionBinding
    private val viewModel: PartnerReviewCustomerTransactionViewModel by viewModels()

    private var transactionId = 0

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityPartnerReviewCustomerTransactionBinding.inflate(layoutInflater)
        ...
        when (state) {
            is UiState.Success -> {
                AlertDialog.Builder(this)
                    .setTitle(getString(R.string.title_partner_review_customer_transaction))
