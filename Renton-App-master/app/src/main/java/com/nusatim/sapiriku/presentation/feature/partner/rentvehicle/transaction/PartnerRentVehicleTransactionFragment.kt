...
import com.nusatim.sapiriku.databinding.FragmentPartnerRentVehicleTransactionBinding
import com.nusatim.sapiriku.presentation.feature.partner.rentvehicle.transaction.adapter.ListPartnerRentVehicleTransactionAdapter
import dagger.hilt.android.AndroidEntryPoint
import kotlinx.coroutines.launch
import com.nusatim.sapiriku.core.util.applyExitTransition
import com.nusatim.sapiriku.presentation.feature.partner.rentvehicle.transactiondetail.PartnerRentVehicleTransactionDetailActivity

@AndroidEntryPoint
class PartnerRentVehicleTransactionFragment : Fragment() {

    private var _binding: FragmentPartnerRentVehicleTransactionBinding? = null
    private val binding get() = _binding!!

    private val viewModel: PartnerRentVehicleTransactionViewModel by viewModels()
    private lateinit var adapter: ListPartnerRentVehicleTransactionAdapter

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        _binding = FragmentPartnerRentVehicleTransactionBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = ListPartnerRentVehicleTransactionAdapter(
            onItemClick = { transaction ->
                val intent = Intent(requireContext(), PartnerRentVehicleTransactionDetailActivity::class.java)
