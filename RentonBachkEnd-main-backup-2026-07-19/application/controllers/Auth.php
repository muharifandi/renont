...
class Auth extends MY_Controller
{
	...
	public function forgot_password()
	{
		...
		else
		{
			...
			if ($forgotten)
			{
				...
				$this->email->subject('Reset Sandi Akun RentOne'); 
				
				$message = $this->load->view($this->config->item('email_templates', 'ion_auth') . $this->config->item('email_forgot_password', 'ion_auth'), $forgotten, TRUE);
				...
				$this->_render_page('auth' . DIRECTORY_SEPARATOR . 'reset_password_message', $this->data);
			}
			else
			{
				$this->session->set_flashdata('message', $this->ion_auth->errors());
	...
	public function reset_password_successfull()
	{
